...
Pyrite Publisher jest programem do konwersji tekstów dla użytkowników
komputerów z Palm OS. Albo, wyrażając się prościej, Pyrite Publisher
pozwala przekształcić informacje w zwykłym formacie takim jak HTML na
coś, co można czytać na organizerach z Palm OS.
